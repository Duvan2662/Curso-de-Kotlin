...
La variable numberOfAdults contiene la cantidad de adultos en el grupo, y la variable numberOfKids, 
...
Después de determinar el resultado, ejecuta el código en Kotlin Playground y, luego, verifica si el resultado 
coincide con el que se muestra.
...
// 1- Se ejecuta 2030
// 2- Se deben quitar las comillas para que se pueda ejecutar el total de personas en la fiesta de las variables
//numberOfAdults y numberOfKids
fun main() {
    val numberOfAdults = 20
    val numberOfKids = 30
    val total = numberOfAdults + numberOfKids 
